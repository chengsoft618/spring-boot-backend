...
public class TopicService {
     ...
     */
    public List<Topic> getUserSpecificTopics() {
        LOGGER.info("Called getUserSpecificTopics() method from TopicService");
        ...
        if (auth.getAuthorities().isEmpty()){
            ...
            throw new NotLoggedInException("You must be logged in to get custom topics!");
        }
