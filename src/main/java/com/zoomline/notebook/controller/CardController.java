package com.zoomline.notebook.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.web.bind.annotation.*;

import com.zoomline.notebook.model.Card;
import com.zoomline.notebook.service.CardService;
...
public class CardController {
     ...
     */
    // UPDATE CARD BY ID
    @PutMapping("{topicName}/cards/{question}")
    public Card updateCard(@PathVariable(value = "topicName") String topicName,
        ...
        return cardService.updateCard(topicName, question, cardObject);
    }
     ...
     * @param question The question of the card to delete.
     */
    // DELETE A CARD BY ID
    @DeleteMapping("{topicName}/cards/{question}")
    public void deleteCard(@PathVariable(value = "topicName") String topicName,
        ...
        cardService.deleteCard(topicName, question);
    }
